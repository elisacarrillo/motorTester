...
public class systemFour extends Subsystem {

  public TalonSRX systemFour = new TalonSRX(8);

//   public double sysPos;
//   private void sysPreset(double sysPos) {
//       this.sysPos = sysPos;
//       }
...
//   }
  ...
  public void initDefaultCommand() {  
    setDefaultCommand(new systemFourGo(OI.sys4));
  }

  // Able to return values and read them off of Shuffleboard or the SmartDashboard
//   public void periodic(){
//     SmartDashboard.putNumber("Current System Two Position", getCurrentPosition());
...
//   }
  ...
  public void setSpeed(double speed){
    systemFour.set(ControlMode.PercentOutput, speed);
  }

  // Method that will stop the clock motor when called
  public void stop() {
    systemFour.set(ControlMode.PercentOutput, 0);
  }
