...
public class systemFive extends Subsystem {

  public TalonSRX systemFive = new TalonSRX(9);
...
//   }
  ...
  public void initDefaultCommand() {
    //setDefaultCommand(new systemFiveGo());
...
//   }
  ...
  public void setSpeed(double speed){
    systemFive.set(ControlMode.PercentOutput, speed);
  }

  // Method that will stop the clock motor when called
  public void stop() {
    systemFive.set(ControlMode.PercentOutput,0);
  }
